<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike10.aspx.cs" Inherits="BikeRents.Bike10" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <p class="auto-style1">
            <asp:Image ID="Image1" runat="server" Height="600px" ImageUrl="https://www.theautomotiveindia.com/forums/attachments/dsc02891-jpg.110544/" Width="800px" />
        </p>
        <p class="auto-style1">
            &nbsp;</p>
        <p class="auto-style1">
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" ForeColor="#3333FF" Text="YAMAHA RX"></asp:Label>
            </strong>
        </p>
        <p class="auto-style1">
...
&nbsp;<asp:Label ID="Label4" runat="server" Text="RX-Z"></asp:Label>
        </p>
        <p class="auto-style1">
            <asp:Label ID="Label5" runat="server" Font-Size="15pt" Text="Rate :"></asp:Label>
&nbsp;<asp:Label ID="Label6" runat="server" Text="1400 / 8Hrs"></asp:Label>
        </p>
        <p class="auto-style1">
