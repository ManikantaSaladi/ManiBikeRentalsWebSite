<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike12.aspx.cs" Inherits="BikeRents.Bike12" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <p class="auto-style1">
            <asp:Image ID="Image1" runat="server" Height="600px" ImageUrl="https://i.pinimg.com/originals/fd/87/af/fd87afad680030bee211f21f5333d5fd.jpg" Width="800px" />
        </p>
        <p class="auto-style1">
            &nbsp;</p>
        <p class="auto-style1">
...
&nbsp;<asp:Label ID="Label4" runat="server" Text="Pulsor 220"></asp:Label>
        </p>
        <p class="auto-style1">
            <asp:Label ID="Label5" runat="server" Font-Size="15pt" Text="Rate :"></asp:Label>
&nbsp;<asp:Label ID="Label6" runat="server" Text="1100 / 8Hrs"></asp:Label>
        </p>
        <p class="auto-style1">
