<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike14.aspx.cs" Inherits="BikeRents.Bike14" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <p class="auto-style1">
            <asp:Image ID="Image1" runat="server" Height="500px" ImageUrl="https://w0.peakpx.com/wallpaper/969/967/HD-wallpaper-cb-shine-125-honda-bikes-honda-shine.jpg" Width="800px" />
        </p>
        <p class="auto-style1">
            &nbsp;</p>
        <p class="auto-style1">
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" ForeColor="#3333FF" Text="SHINE"></asp:Label>
            </strong>
        </p>
        <p class="auto-style1">
...
&nbsp;<asp:Label ID="Label4" runat="server" Text="Honda Shine"></asp:Label>
        </p>
        <p class="auto-style1">
