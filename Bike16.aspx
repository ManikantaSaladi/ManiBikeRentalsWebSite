<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike16.aspx.cs" Inherits="BikeRents.Bike16" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <p class="auto-style1">
            <asp:Image ID="Image1" runat="server" Height="550px" ImageUrl="https://i.pinimg.com/736x/14/87/89/1487896f21173c08df9b5ad1d8fbec83.jpg" Width="800px" />
        </p>
        <p class="auto-style1">
            &nbsp;</p>
        <p class="auto-style1">
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" ForeColor="#3333FF" Text="SPLENDOR"></asp:Label>
            </strong>
        </p>
        <p class="auto-style1">
...
&nbsp;<asp:Label ID="Label4" runat="server" Text="Hero Honda Splendor"></asp:Label>
        </p>
        <p class="auto-style1">
