<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike18.aspx.cs" Inherits="BikeRents.Bike18" %>
...
<body>
    ...
    <form id="form1" runat="server">
        <p class="auto-style1">
            <asp:Image ID="Image1" runat="server" Height="500px" ImageUrl="https://cdn.bikedekho.com/processedimages/tvs/tvs-jupiter/640X309/tvs-jupiter66c6fb388dc8c.jpg" Width="750px" />
        </p>
        <p class="auto-style1">
            &nbsp;</p>
        <p class="auto-style1">
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" ForeColor="#3333FF" Text="ACTIVA"></asp:Label>
            </strong>
        </p>
        <p class="auto-style1">
...
&nbsp;<asp:Label ID="Label4" runat="server" Text="Activa 6G"></asp:Label>
        </p>
        <p class="auto-style1">
