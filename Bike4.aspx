<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Bike4.aspx.cs" Inherits="BikeRents.Bike4" %>
...
<body>
    <form id="form1" runat="server">
        <div class="auto-style1">
            <br />
            <br />
            <asp:Image ID="Image1" runat="server" Height="550px" ImageUrl="https://i.pinimg.com/736x/24/14/a4/2414a4fec6478b62867d18aa67b5c373.jpg" Width="800px" />
            <br />
            <br />
            <strong>
            <asp:Label ID="Label1" runat="server" CssClass="auto-style2" ForeColor="#3333FF" Text="JAWA"></asp:Label>
            <br />
            <br />
            </strong>
            ...
            <asp:Label ID="Label4" runat="server" Text="Jawa"></asp:Label>
            <br />
            <asp:Label ID="Label5" runat="server" Font-Size="15pt" Text="Rate :"></asp:Label>
&nbsp;<asp:Label ID="Label6" runat="server" Text="1350 / 8 Hrs"></asp:Label>
            <br />
            <br />
